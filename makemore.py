"""in machine learning there are the top tree types of models being used
1)predictive data modelling(rank:easy)
2)image recognition models(rank:easy/medium)
3)generative ai models(rank:hard)
"""
"""
...
def create_datasets(input_file):
    '''
    this is finding the all the information about the dataset being passed in and splits the data
    '''
